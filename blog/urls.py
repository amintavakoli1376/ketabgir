...
from .views import ArticleList, ArticleDetail, ArticlePreview, SearchList, LikeView, newsletter_signup, newsletter_unsubscribe
from . import views
...
urlpatterns = [
    ...
    path('tag/<slug:tag_slug>/', views.post_list, name='posts'),
    path('newsletter/sign_up', newsletter_signup, name='newsletter_signup'),
    path('newsletter/unsubscribe', newsletter_unsubscribe,
