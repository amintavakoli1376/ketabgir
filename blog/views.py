...
def newsletter_signup(request):
    ...
    if form.is_valid():
        ...
        if NewsletterUser.objects.filter(email=instance.email).exists():
            messages.warning(request, 'این ایمیل قبلا وارد شده است',
                             "alert alert-warning alert-dismissible")
        else:
            instance.save()
            messages.success(request, 'ایمیل با موفقیت ثبت شد',
...
def newsletter_unsubscribe(request):
    ...
    if form.is_valid():
        ...
        if NewsletterUser.objects.filter(email=instance.email).exists():
            ...
            messages.success(request, 'اشتراک شما حذف شد',
                             "alert alert-success alert-dismissible")
            ...
            messages.warning(request, 'این ایمیل قبلا ثبت نشده است',
                             "alert alert-warning alert-dismissible")
